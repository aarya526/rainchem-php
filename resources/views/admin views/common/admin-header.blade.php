   ...
   <nav class="navbar">
       <div class="container-fluid">
           <div class="navbar-header">
               ...
               <a class="navbar-brand" href="/admin/dashboard">RAINCHEM ADMIN</a>
           </div>
   ...
   <section>
       ...
       <aside id="leftsidebar" class="sidebar">
           ...
           <div class="user-info">
               <div class="image">
                   <img src="/admin/img/user.png" width="48" height="48" alt="User" />
               </div>
               <div class="info-container">
                   <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Parent Admin
                   </div>
                   <div class="email">All Priviledges</div>
           ...
           <div class="menu">
               <ul class="list">
                   ...
                   <li class="active">
                       ...
                       <ul class="ml-menu">
                           <li>
                               <a href="/admin/all-orders">View Orders</a>
                           </li>
                           <li>
                               <a href="/admin/payments">Payment Status</a>
                           </li>
                       </ul>
                       {{-- </li>
           ...
           <div class="legal">
               <div class="copyright">
                   &copy; 2024 <a href="javascript:void(0);">RAINCHEM INDIA PRIVATE LTD.</a>
               </div>
               <div class="version">
                   <b>Version: </b> 2024
               </div>
