    ...
    <div class="container">
        ...
        <div class="col-3">
            ...
            <ul class="footer-links">
                ...
                <li class="footer-link"><a href="/contactUs">Contact Us</a></li>
            </ul>
        </div>
        <div class="col-3">
            ...
            <ul class="footer-links">
                ...
                <li class="footer-link"><a href="/privacyPolicy">Privacy Policy</a></li>
                <li class="footer-link"><a href="/terms">Terms & Condition</a></li>
